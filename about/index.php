        ...
        <div class="container flex">
            ...
            <div class="col-xs-12 col-md-6 col-md-7">
                ...
                <div class="col-xs-12 col-md-5">
                    <div class="txt2">
                        Чем дороже вы продаете тем больше получаете <br>
						В личном кабинете есть удобный инструмент для максимизации вашего вознаграждения<br>
						Просто измени положение бегунка и увеличь свое вознаграждение
                    </div>
                </div>
    ...
    <section class="p3">
        <div class="container flex">
            ...
            <div class="col-xs-12 col-md-6 col-md-7">
                ...
                <div class="txt2">
					Вам не нужно быть экспертом что продавать наше оборудование, мы разработали готовые комплекты, учитывающие особенности автомобильных марок которые вы продаете. <br>
					Если возникнет сложность по работе с личным кабинетом, всегда придет на помощь Ваш персональный менеджер.
                </div>
            </div>
        </div>
    </section>
